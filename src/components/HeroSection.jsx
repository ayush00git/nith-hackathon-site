  ...
  return (
    ...
    <div className="relative min-h-screen w-full bg-white flex flex-col items-center justify-center overflow-hidden font-sans selection:bg-cyan-100 selection:text-cyan-900">      
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute inset-0 bg-[linear-gradient(to_right,#80808012_2px,transparent_3px),linear-gradient(to_bottom,#80808012_2px,transparent_1px)] bg-[size:24px_24px] [mask-image:radial-gradient(ellipse_80%_50%_at_50%_30%,#000_70%,transparent_100%)]"></div>
      </div>
